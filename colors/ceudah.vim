...
call s:HL('Constant',                       s:orange,   '',         'italic')
...
call s:HL('String',                         s:green,    '',         'italic')
...
call s:HL('rubySymbol',                     s:red,      '',         'italic')
